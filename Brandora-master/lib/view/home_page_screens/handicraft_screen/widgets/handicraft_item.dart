...
class HandicraftItem extends StatefulWidget {
  const HandicraftItem({super.key});

  @override
  State<HandicraftItem> createState() => _HandicraftItemState();
}

class _HandicraftItemState extends State<HandicraftItem> {
