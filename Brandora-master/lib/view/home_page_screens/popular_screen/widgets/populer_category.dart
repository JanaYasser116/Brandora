...
class PopulerCategory extends StatefulWidget {
  const PopulerCategory({super.key});

  @override
  State<PopulerCategory> createState() => _PopulerCategoryState();
}

class _PopulerCategoryState extends State<PopulerCategory> {
